...
import com.example.lighthouse.databinding.ActivitySubcategoryProductPreviewBinding

class SubCategoryProductPreviewActivity : AppCompatActivity() {
    private companion object {
        private const val TAG = "SubCategoryProductPreview"
    }
    
    private lateinit var binding: ActivitySubcategoryProductPreviewBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivitySubcategoryProductPreviewBinding.inflate(layoutInflater)
